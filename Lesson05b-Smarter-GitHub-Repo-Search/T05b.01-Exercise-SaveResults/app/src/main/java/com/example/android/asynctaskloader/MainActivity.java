...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String URL_BUNDLE_KEY = "url_key";
    // TODO (2) Create a static final key to store the search's raw JSON
    private static final String JSON_BUNDLE_KEY = "json_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(URL_BUNDLE_KEY))
                mUrlDisplayTextView.setText(savedInstanceState.getString(URL_BUNDLE_KEY));
            if (savedInstanceState.containsKey(JSON_BUNDLE_KEY))
                mSearchResultsTextView.setText(savedInstanceState.getString(JSON_BUNDLE_KEY));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(JSON_BUNDLE_KEY, json);
    }
