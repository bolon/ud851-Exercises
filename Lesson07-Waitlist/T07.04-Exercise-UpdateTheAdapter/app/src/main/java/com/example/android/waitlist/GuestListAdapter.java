...
public class GuestListAdapter extends RecyclerView.Adapter<GuestListAdapter.GuestViewHolder> {
    ...
    public void onBindViewHolder(GuestViewHolder holder, int position) {
        ...
        holder.nameTextView.setText(mCursor.getString(mCursor.getColumnIndex(WaitlistEntry.COLUMN_GUEST_NAME)));

        // TODO (7) Call getInt on the cursor to get the party size
        // TODO (9) Set the holder's partySizeTextView text to the party size
        holder.partySizeTextView.setText(String.valueOf(mCursor.getInt(mCursor.getColumnIndex(WaitlistEntry.COLUMN_PARTY_SIZE))));
    }
